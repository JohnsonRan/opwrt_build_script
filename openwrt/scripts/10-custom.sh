...
sed -i '/# opkg mirror/a case $(uname -m) in\n    x86_64)\n        echo -e '\''src/gz immortalwrt_luci https://mirrors.vsean.net/openwrt/snapshots/packages-23.05/x86_64/luci\nsrc/gz immortalwrt_packages https://mirrors.vsean.net/openwrt/snapshots/packages-23.05/x86_64/packages'\'' >> /etc/opkg/distfeeds.conf\n        ;;\nesac' package/new/default-settings/default/zzz-default-settings
