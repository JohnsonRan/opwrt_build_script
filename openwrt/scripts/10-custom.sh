...
#qosmate
if curl -s "https://$mirror/openwrt/23-config-common" | grep -q "^CONFIG_PACKAGE_luci-app-qosmate=y"; then
git clone https://github.com/hudra0/qosmate package/new/qosmate
git clone https://github.com/hudra0/luci-app-qosmate package/new/luci-app-qosmate
rm -rf package/network/utils/iproute2
cp -a ../master/openwrt/package/network/utils/iproute2 package/network/utils/iproute2
mkdir -p package/new/luci-app-qosmate/po/zh_Hans
curl -Lso https://github.com/JohnsonRan/openwrt-qosmate/raw/main/qosmate.po
mv qosmate.po package/new/luci-app-qosmate/po/zh_Hans/qosmate.po
fi
